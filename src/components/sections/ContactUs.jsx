...
const ContactUs = () => {
  return (
    <div className="w-full flex justify-between pt-28 pb-24">
      <div className=" flex-auto p-12 flex flex-col items-end justify-start gap-5">
        <Title className="font-Poppins">Lets Get In Touch</Title>
        <Text className="font-Poppins max-w-md text-right">
