...
const useStyles = createStyles((theme) => ({
  root: {
    ...
    backgroundImage:
      "linear-gradient(250deg, rgba(0, 0, 0, 0.3) 30%, #062e17 70%), url(https://images.unsplash.com/photo-1563089145-599997674d42?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)",
...
export function HeroImageRight() {
  ...
  return (
    <div className={`${classes.root} w-screen mb-12`}>
      <Container size="xl">
